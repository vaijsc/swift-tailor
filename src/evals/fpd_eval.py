...
class PFID_evaluator:
    ...
    def compute_pfid(self, pc_1, pc_2, return_feature=False):
        ...
        # print(features_1.max(), features_1.min(),
        # features_1.mean(), features_1.std() )
        ...
        # print(features_2.max(), features_2.min(), features_2.mean(),
        # features_2.std() )
        ...
        PFID = frechet_distance(
            stats_1.mu, stats_1.sigma, stats_2.mu, stats_2.sigma
        )
