...
class MetaGarment(pyg.Component):
    ...
    def __init__(self, name: str, body: BodyParameters, design: Dict) -> None:
        ...
        if self.lower_name:
            ...
            Lower = Lower_class(
                ...
                rise=(
                    1.0
                    if self.upper_name and "Fitted" in self.upper_name
                    else None
                ),
            )
        else:
        ...
        if self.belt_name:
            ...
            Belt = Belt_class(body, design, Lower.get_rise() if Lower else 1.0)
            ...
            # Add waist label
            self.subs[-1].interfaces["top"].edges.propagate_label(
                "lower_interface"
            )
    ...
    def assert_skirt_waistband(self):
        ...
        if self.lower_name and self.lower_name in [
            "SkirtCircle",
            "AsymmSkirtCircle",
            "SkirtManyPanels",
        ]:
