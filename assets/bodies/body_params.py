...
class BodyParameters(pyg.BodyParametrizationBase):
    ...
    def eval_dependencies(self, key=None):
        ...
        if key in ["height", "head_l", "waist_line", "hips_line", None]:
            self.params["_waist_level"] = (
                self.params["height"]
                - self.params["head_l"]
                - self.params["waist_line"]
            )
            self.params["_leg_length"] = (
                self.params["_waist_level"] - self.params["hips_line"]
            )
